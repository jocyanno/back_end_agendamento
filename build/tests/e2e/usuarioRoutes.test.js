...
// src/tests/e2e/usuarioRoutes.test.ts
...
describe("Usuario Routes E2E", () => {
  ...
  describe("POST /user/login", () => {
    it("deve fazer login com credenciais v\xE1lidas", async () => {
      ...
      globalExpect(body.data).toHaveProperty("token");
      globalExpect(body.data).toHaveProperty("usuario");
      globalExpect(body.data.usuario.email).toBe("user@test.com");
    });
    it("deve retornar erro com credenciais inv\xE1lidas", async () => {
      const response = await app.inject({
        method: "POST",
        url: "/user/login",
        payload: {
  ...
  describe("POST /user", () => {
    it("deve criar novo usu\xE1rio com dados v\xE1lidos", async () => {
      const userData = {
      ...
      globalExpect(body.status).toBe("success");
      globalExpect(body.data).toHaveProperty("token");
      globalExpect(body.data.usuario.email).toBe("newuser@test.com");
      globalExpect(body.data.usuario.register).toBe("patient");
    });
  ...
  describe("GET /user", () => {
    it("deve retornar dados do usu\xE1rio logado", async () => {
      ...
      const body = JSON.parse(response.body);
      globalExpect(body.status).toBe("success");
      globalExpect(body.data.email).toBe("user@test.com");
      globalExpect(body.data).not.toHaveProperty("password");
    });
  ...
  describe("PUT /user", () => {
    it("deve atualizar dados do usu\xE1rio logado", async () => {
      const user = await createTestUser({
        email: "user@test.com",
        password: "user123456",
        cpf: "22222222222",
      ...
      globalExpect(response.statusCode).toBe(200);
      const body = JSON.parse(response.body);
      globalExpect(body.data.name).toBe("Updated Name");
      globalExpect(body.data.phone).toBe("11999999999");
    });
    it("deve retornar erro sem token", async () => {
      const response = await app.inject({
        method: "PUT",
  ...
  describe("POST /user/admin", () => {
    it("deve permitir doctor criar usu\xE1rio", async () => {
      ...
      globalExpect(response.statusCode).toBe(200);
      const body = JSON.parse(response.body);
      globalExpect(body.data.usuario.register).toBe("doctor");
    });
    it("deve impedir usu\xE1rio patient de criar usu\xE1rio", async () => {
      const user = await createTestUser({
        email: "user@test.com",
        password: "user123456",
        cpf: "22222222222",
  ...
  describe("DELETE /user/:id", () => {
    it("deve permitir doctor deletar usu\xE1rio", async () => {
      const admin = await createTestUser({
        email: "admin@test.com",
        password: "admin123456",
        cpf: "11111111111",
      ...
      globalExpect(response.statusCode).toBe(200);
      const body = JSON.parse(response.body);
      globalExpect(body.data.message).toBe("User deleted successfully");
    });
    it("deve impedir usu\xE1rio patient de deletar", async () => {
      const user = await createTestUser({
        email: "user@test.com",
        password: "user123456",
        cpf: "22222222222",
    ...
    it("deve retornar erro ao deletar usu\xE1rio inexistente", async () => {
      const admin = await createTestUser({
        email: "admin@test.com",
        password: "admin123456",
        cpf: "11111111111",
