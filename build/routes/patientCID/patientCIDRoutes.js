...
var patientCIDRoutes_exports = {};
__export(patientCIDRoutes_exports, {
  patientCIDRoutes: () => patientCIDRoutes
});
module.exports = __toCommonJS(patientCIDRoutes_exports);
...
// src/routes/patientCID/patientCIDRoutes.ts
async function patientCIDRoutes(app) {
  app.withTypeProvider().addHook("preHandler", autenticarToken).post("/patient-cids", createPatientCIDController);
  app.withTypeProvider().addHook("preHandler", autenticarToken).put("/patient-cids/:id", updatePatientCIDController);
  app.withTypeProvider().addHook("preHandler", autenticarToken).delete("/patient-cids/:id", deletePatientCIDController);
  app.withTypeProvider().addHook("preHandler", autenticarToken).get("/patient-cids/patient/:patientId", getPatientCIDsController);
  app.withTypeProvider().addHook("preHandler", autenticarToken).get("/patient-cids/professional", getProfessionalCIDsController);
  app.withTypeProvider().addHook("preHandler", autenticarToken).get("/patient-cids/:id", getPatientCIDByIdController);
}
